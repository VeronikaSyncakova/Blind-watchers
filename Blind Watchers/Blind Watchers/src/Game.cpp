...
void Game::changeGameMode()
{
	if (s_changeGameMode)
	{
		...
		else if (s_currentGameMode == GameModeClass::GameLose)
			m_gameMode = std::make_shared<GameLose>();
		else if (s_currentGameMode == GameModeClass::GameWin)
			m_gameMode = std::make_shared<GameWin>();
